    ...
    <div className="glass-card rounded-[26px] px-4 py-4 md:px-5">
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_180px_160px_auto] xl:items-center">
        ...
        <div className="surface-subtle py-3">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Received</div>
          <div className="mt-2 text-sm font-semibold text-slate-900">{formatDateTime(email.received_at)}</div>
        ...
        <div className="surface-subtle py-3">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">AI confidence</div>
          ...
          <div className="mt-2 h-2 rounded-full bg-slate-200">
            <div
              className="h-2 rounded-full bg-gradient-to-r from-cyan-500 to-amber-400"
