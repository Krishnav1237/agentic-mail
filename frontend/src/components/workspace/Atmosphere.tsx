 ...
 * water.
 *
 * Pure CSS, no canvas or image assets. Each beam (`.obligo-beam-slot--N`) has two
 ...
 *
 * The line (`.obligo-beam`) is one continuous filled shape per layer (outer
 ...
 * only `.obligo-beam-wave`'s `scaleY` breathes the whole thing in and out —
 ...
 * per beam) — lives inside `.obligo-beam` alongside outer/glow/core, so it
 ...
 *
 * Motion composes on the existing `.obligo-beam-slot` / `.obligo-beam-wave`
 ...
 * `.obligo-root`, so this component holds no theme state.
 *
...
function Beam({ index }: { index: 1 | 2 | 3 }) {
  return (
    <div className={`obligo-beam-slot obligo-beam-slot--${index}`}>
      <div className={`obligo-beam-wave obligo-beam-wave--${index}`}>
        <div className={`obligo-beam obligo-beam--${index}`}>
          <div className="obligo-beam-outer" />
          <div className="obligo-beam-glow" />
          <div className="obligo-beam-core" />
          <div className={`obligo-beam-grain obligo-beam-grain--${index}a`} />
          <div className={`obligo-beam-grain obligo-beam-grain--${index}b`} />
        </div>
      </div>
    </div>
  );
...
export function Atmosphere() {
  return (
    <div className="obligo-atmosphere" aria-hidden="true">
      {/* Constant, non-animated wash covering the shell's own footprint (the
          ...
          of its own (see .obligo-beam-slot / travel keyframes) — their combined
      ...
      <div className="obligo-shell-ambient" />
      <Beam index={1} />
      <Beam index={2} />
      <Beam index={3} />
      <div className="obligo-vignette" />
    </div>
  );
}
