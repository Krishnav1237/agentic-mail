...
export default function ConnectPrompt() {
  return (
    <div className="glass-card overflow-hidden rounded-[30px] p-8">
      <div className="grid gap-6 xl:grid-cols-[1fr_0.9fr] xl:items-center">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500">
            Connect your workspace
          </div>
          <h3 className="mt-4 font-display text-3xl font-semibold tracking-tight text-slate-950">
        ...
        <div className="grid gap-4">
          ...
          <div className="surface-card">
            <div className="flex items-center gap-3 text-slate-900">
              <LockKeyhole className="text-cyan-700" size={18} />
