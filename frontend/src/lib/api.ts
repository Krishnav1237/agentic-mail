...
export const getDashboard = () => apiFetch('/tasks/dashboard') as Promise<DashboardSections>;
export const getSession = () => apiFetch('/auth/session') as Promise<SessionResponse>;
...
export const getAgentActions = (params: { limit?: number; offset?: number; status?: string }) =>
  apiFetch(`/agent/actions${buildQuery(params)}`) as Promise<AgentActionsResponse>;

export const getActivityFeed = () => apiFetch('/agent/activity-feed') as Promise<{ feed: { summary: ActivityFeed; summary_date: string } | null }>;

export const getGoals = () => apiFetch('/agent/goals') as Promise<GoalsResponse>;
...
export const getPreferences = () => apiFetch('/preferences') as Promise<PreferencesResponse>;
