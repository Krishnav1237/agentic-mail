/**
 * The Help & Feedback contract — how a user reaches the Obligo team, kept
 * distinct from Settings (how Obligo behaves) and Profile (who the user is);
 ...
 * was sent to this form, not that the Obligo team received and read it, until a
